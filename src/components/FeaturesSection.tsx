...
import { Brain, LineChart, Puzzle, FileText, Rocket, Shield, Sparkles, Target, Zap } from "lucide-react";
const features = [{
  icon: Brain,
...
export const FeaturesSection = () => {
  return <section id="features" className="py-24 bg-background-secondary">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => <Card key={index} className="p-6 border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-card group">
              <div className="mb-4">
